...
> 서로 다른 코드와 공간 단위의 주민등록인구·HIRA·SGIS 데이터를 전국 229개 지역으로
> 정합하고, API 쿼터와 중단 복구를 고려해 106,770개 자동차 경로를 구축했습니다.
> 2SFCA 의료 접근성과 병원 폐업 What-if를 FastAPI·Supabase로 제공하고, 실제 폐업
> 237건과 시간 홀드아웃 기준선으로 분석 결과를 검증했습니다.
